...
const whitepaper = `
  ...
  The community <b>burns the field down to a deck of 77</b> by burning the token itself, and at
  season end the survivors — and any retired card whose edition gets <b>compressed</b> — live on
  as <b>1/1 collectible lenses</b>. Everything burns; nothing is skimmed. No treasury, no team
  ...
  <ul>
    ...
    <li><b>Season end</b> — the <b>77 survivors</b> mint as 1/1 lenses; retired cards can be <b>compressed into 1/1s</b> (§6); the rest stand as ash with the final burner's name on the trophy.</li>
  </ul>
  ...
  <h2><span class="n">06</span>Seasons &amp; the Compression rite</h2>
  <p>Four a year, on the calendar — and we launch in the season we're in: <b>Summer</b> (live), then Fall,
  Winter, Spring. Each season opens a full field and the crowd burns it to 77 on the milestone queue; the
  render grays each casualty to ash in real time.</p>
  <p><b>At season end, every card gets a fate.</b> The <b>77 survivors</b> mint as <b>1/1 lenses</b> — the
  standard deck, ownable. Each <b>retired</b> card faces the <b>Compression rite</b>: whoever holds its full
  claim set (cornered its rip-claims over the season) chooses — let it <b>stand as ash</b>, or <b>compress
  it</b>: burn the compression cost and the card is <b>reborn as a 1/1 lens</b>, retired from the deck but
  alive as a collectible. Whoever's burn landed each final blow is offered the <b>Ash-Trophy</b> lens.</p>
  <div class="callout"><div class="co-h">The end state.</div>
    <p>Potentially the <b>entire original 196</b> lives on as 1/1 cards — 77 survivors + up to 119
    compressed rebirths — a permanent museum of a field that no longer exists. Nothing is deleted;
    everything ends as a survivor, a reborn 1/1, or ash with a name on it.</p></div>
