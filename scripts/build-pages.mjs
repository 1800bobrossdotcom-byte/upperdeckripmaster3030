...
const whitepaper = `
  ...
  <ul>
    ...
    <!-- ⛔ NINE TITLES, ELEVEN CARDS. Two passes on 2026-08-06 each spent the same 11-card
         earned budget — three seats on THE STREAK plus two THE CITY titles from one, five
         points/combo cards from the other — and together they wanted 16. The set below is the
         resolution that keeps 11 auction + 11 gacha + 11 earned = 33 intact, so no aggregate
         on this page moves. ⚠ DOGFIGHT owns no title as a result; that is a regression on this
         file's own "every cabinet owns one" rule and is recorded, with three ways to reverse it,
         in docs/HERO-UNLOCKS.md §4. Do not quietly re-add a title here — it breaks the 33. -->
    <li><b>TWO MILLION FEET</b> · <i>Rip Rocketer</i> — post a run of <b>2,000,000 points</b>. Clearing the whole facility scores about 690,000, so this is roughly <b>wave 38</b>.</li>
    <li><b>ABOVE THE WEATHER</b> · <i>Rip Rocketer</i> — post a run of <b>5,000,000 points</b>, about <b>wave 75</b>.</li>
