...
<style>
  ...
  *{ box-sizing:border-box; }
  ...
  body{ margin:0; padding:0; font-family:var(--mono); color:var(--text); line-height:1.6;
    background:
  ...
  .fine{ font-size:12px; color:var(--phosdim); text-shadow:0 1px 2px rgba(0,0,0,.9), 0 0 6px rgba(0,0,0,.7); }
