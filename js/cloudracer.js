...
(() => {
  ...
  function endRace() {
    ...
    else $('prizeBig').textContent = onPodium ? (WagerPayout.ordinal(P.myPlace) + ' · +' + P.myTok.toLocaleString('en-US') + ' $3030 · +' + wonSlugs.length + ' cards') : ('off the podium · 🔥' + P.anteBurn + ' rake burned');
