...
window.RRFx = (function () {
  ...
  const MAXB = 96;           // backdrop quads: an 8×6 vertex-coloured field far behind everything
  ...
  function create(app) {
    ...
    function push(buf, cell, ax, ay, az, bx, by, bz, cx, cy, cz, dx, dy, dz, r, g, b, a) {
      ...
      const R = r < 0 ? 0 : r > 255 ? 255 : r | 0, G = g < 0 ? 0 : g > 255 ? 255 : g | 0,
        B = b < 0 ? 0 : b > 255 ? 255 : b | 0, Aa = a < 0 ? 0 : a > 255 ? 255 : a | 0;
