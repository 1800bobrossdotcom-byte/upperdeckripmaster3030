...
| **Pack** | — | **350 $UR3030, bought then split 50/50 (burn / studio)** | ≈ $7 at launch, seven cards; a *fixed-USD ritual*, escalating base→ceil within a season |
...
|---|---|---|---|
| 1 | Milestones 4,355,400 > 3,030,000 (mint-once can't complete) | **Resolved — mechanic removed** | v2.2 cut forced card retirement entirely; only TOKEN deflation remains (Σ pack burns ≤ cap; ≈1.01M at the 33M cap + 50% pack split), `scripts/token-model.mjs` |
