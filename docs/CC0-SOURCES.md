...
| **Rare Pepe (Counterparty, 2016–18)** | **In scope.** Artist direction. | Artist direction, 2026-07-31, from inside the scene: *"pepe is fine as well — or else fake rares wouldn't exist and rare pepes, and would be taken down."* The artist is **@_lovebeing_**, a Fake Rare / Rare Pepe artist who knows the artists in this table personally. | **ATTESTED** | — | The scene's own norms are the operative fact here, and the artist is a participant in it rather than an observer of it — the same basis as the Darkfarms row, which this file already treats as its strongest non-published grade. The artist's own cards need no further word from anyone. For another artist's specific card, the artist has the relationships; that is a DM, not a research task. |
| **Fake Rares / Dank Rares** | **In scope.** Artist direction, and the artist's own submissions outright. | Same direction as above. The artist came up in this scene and their own submissions are their own work. | **ATTESTED** | — | ⚑ **The artist's own Fake Rares work is the natural first source for in-game art** — it is the project's actual lineage and the strongest answer this repo can give to "where did this come from". |
